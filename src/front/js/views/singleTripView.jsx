...
const SingleTrip = (props) => {
    ...
    if (data != "") {
        ...
        trvlName =
            trvlName.charAt(0).toUpperCase() + trvlName.slice(1).toLowerCase();

        trvlCity = data.city.toLowerCase();
        trvlCity =
            trvlCity.charAt(0).toUpperCase() + trvlCity.slice(1).toLowerCase();

        trvlCountry = data.country_code.toLowerCase();
        trvlCountry =
            trvlCountry.charAt(0).toUpperCase() +
            trvlCountry.slice(1).toLowerCase();
                    ...
                    <Row>
                                                ...
                                                >
                                                    {i == 0 ? (
                                                        <i
                                                            ...
                                                            Style="font-size:30px;Color:#4be89f"
                                                        >
                                                            {" "}
                                                            {i}
                                                        </i>
                                                        ...
                                                        <i
                                                            className="fa-solid fa-map-pin"
                                                            Style="font-size:30px;Color:#EA1889"
                                                        >
                                                            {" "}
                                                            {i}
                                                        </i>
                        ...
                        <Col xs={12} lg={6}>
                            <Row className="mt-5 p-3 d-flex justify-content-start card-row">
                                <Row className="py-2">
                                    <h2 className="d-flex justify-content-start singletrip-title">
                                        {trvlName}
                                    </h2>
                                </Row>
                                <h3>
                                    <i class="fa-solid fa-location-dot"></i>{" "}
                                    {trvlCity}, {trvlCountry}
                                </h3>
                                <h6>
